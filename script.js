	...
	*/
	function checkNeighbour(field){
		...
		// for(let i = 0; i < field.length; i++){
		// 	for(let j = 0; j < field[i].length; j++){ // /**/-значит проверено и протестировано
		// 	/**/if(i == 0 && j == 0){
		// 			check = 1;
		// 			k = i;//Итераторы
		// 			l = j;
		...
		// 			m = i + 2;
		// 			n = j + 2;
		// 	/**/}else if(i != 0 && i != field.length - 1 && j != 0 && j != field[i].length - 1){
		// 			check = 5;
		// 			k = i - 1;
		// 			l = j - 1;
		// 			m = i + 2;
		...
		// 			m = i + 1;
		// 			n = j + 2;
		// 	/**/}else if(i == field.length - 1 && j == field[i].length - 1){
		// 			check = 9;
		// 			k = i - 1;
		// 			l = j - 1;
		// 			m = i + 1;
